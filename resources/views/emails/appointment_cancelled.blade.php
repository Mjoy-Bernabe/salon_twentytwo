...
<head>
    ...
    <style>
        ...
        .status { background:#fee2e2; border:1px solid #fecaca; color:#991b1b; padding:14px 20px; font-size:12px; font-weight:800; text-transform:uppercase; letter-spacing:0.12em; margin-bottom:24px; text-align:center; }
...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <p class="intro">
            We are writing to let you know that your appointment has been cancelled.
        </p>

        <div class="status">Appointment Cancelled</div>
        ...
        <p class="intro" style="margin-bottom:0;">
            You may book another appointment anytime through the SalonTwentyTwo website.
        </p>
    </div>
    <div class="footer">
