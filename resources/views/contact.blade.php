                ...
                <div class="space-y-12">
                    <div class="grid grid-cols-2 gap-8">
                        <div>
                            ...
                            <p class="text-base text-gray-500 leading-relaxed">Main Branch, Pasig City<br>Metro Manila, PH</p>
                        </div>
                        <div>
                            <h4 class="text-sm font-black uppercase tracking-widest mb-4">Inquiries</h4>
                            <p class="text-base text-gray-500">hello@salontwentytwo.com<br>+63 915 484 7080</p>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-200 pt-12">
                        ...
                        <div class="flex gap-8">
                            <a href="#" class="text-base font-bold uppercase tracking-widest text-black no-underline hover:text-yellow-600">Instagram</a>
                            <a href="#" class="text-base font-bold uppercase tracking-widest text-black no-underline hover:text-yellow-600">Facebook</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-12 md:p-16 shadow-2xl rounded-sm">
                <form action="#" method="POST">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" class="contact-input" placeholder="Vince Russel">
                    </div>

                    <div class="grid grid-cols-2 gap-8">
                        <div>
                            <label class="contact-label">Email</label>
                            <input type="email" name="email" class="contact-input" placeholder="vince@example.com">
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <textarea name="message" rows="4" class="contact-input resize-none" placeholder="How can we help you?"></textarea>
                    </div>
