          ...
          <div class="rounded-3xl border border-slate-200 bg-slate-50 p-4">
            <div class="flex items-start justify-between">
              ...
              <div class="flex gap-2">
                ...
                <form action="{{ route('admin.stylists-schedule.delete', $schedule->id) }}" method="POST" class="inline-block" data-confirm data-confirm-title="Delete Schedule" data-confirm-message="Delete this schedule on {{ $schedule->day }} ({{ $schedule->start_time }} - {{ $schedule->end_time }})?">
                  @csrf
                  @method('DELETE')
