...
<nav class="flex justify-between items-center px-12 py-5 bg-white border-b border-gray-100">
  <a href="{{ route('home') }}" class="text-sm font-bold tracking-widest uppercase">
...
<section class="relative h-screen bg-black overflow-hidden flex items-end">
  ...
  <div class="relative z-10 p-16 pb-20">
    ...
    <a href="{{ route('booknow') }}" class="inline-block bg-yellow-600 hover:bg-yellow-700 text-white text-xs font-semibold tracking-widest uppercase px-9 py-4 transition-colors">
      Book an Appointment
    </a>
  </div>
</section>
...
<section class="bg-stone-50 py-24 px-12 text-center">
  ...
  <p class="text-sm text-gray-400 max-lg mx-auto leading-loose">
...
<section class="grid grid-cols-2 min-h-[600px]">
  ...
  <div class="flex flex-col justify-center px-16 py-20">
    ...
    <a href="{{ route('services.index') }}" class="inline-block border border-black hover:bg-black hover:text-white text-xs font-semibold tracking-widest uppercase px-7 py-4 transition-all w-fit">
      View All Services
    </a>
  </div>
</section>
...
<section class="bg-black py-24 px-12 text-center">
  ...
  <a href="{{ route('booknow') }}" class="inline-block bg-yellow-600 hover:bg-yellow-700 text-white text-xs font-semibold tracking-widest uppercase px-10 py-4 transition-colors">
    Book Now
  </a>
</section>
